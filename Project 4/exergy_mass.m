function x = exergy_mass(fluid, Po, To)
...
%%%%%
% Example values for standard chemical exergies (or potentials) in kJ/mol
% These are hypothetical values and should be replaced with accurate ones
mu_o_CO2 = -394.4; % Chemical exergy of CO2
mu_o_H2O = -237.2; % Chemical exergy of H2O
mu_o_N2 = 0;       % Chemical exergy of N2, often considered 0 in air
mu_o_O2 = 0;       % Chemical exergy of O2, can vary
mu_o_AR = 0;       % Chemical exergy of AR, often considered 0

% Assuming the speciesIndex is correctly mapped to these indices
mu_o = zeros(1, nSpecies(fluid)); % Initialize mu_o with zeros for all species

% Assigning the chemical exergies to the respective indices
mu_o(iCO2) = mu_o_CO2;
mu_o(iH2O) = mu_o_H2O;
mu_o(iN2)  = mu_o_N2;
mu_o(iO2)  = mu_o_O2;
